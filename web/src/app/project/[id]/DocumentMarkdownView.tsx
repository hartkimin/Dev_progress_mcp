...
interface DocumentMarkdownViewProps {
    projectId: string;
    docType: 'API' | 'API_GUIDE' | 'ENVIRONMENT' | 'CHANGELOG' | 'DEPENDENCIES' | 'DECISION';
    title: string;
}

export default function DocumentMarkdownView({ projectId, docType, title }: DocumentMarkdownViewProps) {
